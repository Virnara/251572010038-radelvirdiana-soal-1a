# Menggunakan base image Nginx berukuran ringan
FROM nginx:alpine
...
# Menyalin folder html lokal ke direktori default Nginx
COPY html/ /usr/share/nginx/html/

# Menggunakan sed untuk mengganti string placeholder dengan data asli saat proses build
